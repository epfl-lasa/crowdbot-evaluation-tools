#!/usr/bin/env python
# modified from https://github.com/smarnakis/trajectory-smoothing-ros/blob/master/trajectory_smoothing/scripts/trajectory_smoothing_function.py
import numpy as np
import math
...
def smooth_traj(x,y,z,t,down=[],p=[],case=0):
