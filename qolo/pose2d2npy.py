...
def extract_pose2d_from_rosbag(bag_file_path, args):
    ...
    with rosbag.Bag(bag_file_path, 'r') as bag:
        ...
        print('Found odom topic: {} with {} messages'.format(args.odom_topic, total_num_odom_msgs))
        ...
        for topic, msg, t in bag.read_messages():
            if topic == args.odom_topic:
                ...
                if pose2d_msg_sum % num_msgs_between_logs == 0 or pose2d_msg_sum >= total_num_odom_msgs - 1:
                    print('Pose2D messages: {} / {}'.format(pose2d_msg_sum + 1, total_num_odom_msgs))
                pose2d_msg_sum += 1
    ...
    pose2d_stamped_dict = {'timestamp': t_np, 
                          'x': x_np, 
                          'y': y_np,
                          'theta': theta_np}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--odom_topic', default='/t265/odom/sample', type=str,
